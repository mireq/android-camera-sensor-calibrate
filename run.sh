#!/bin/bash
set -e
#aapt package -f -I $ANDROID_PLATFORM/android.jar -J src -m -M AndroidManifest.xml -S res -v
...
CLASSPATH=$ANDROID_TOOLS/lib/* java com.android.sdklib.build.ApkBuilderMain build/CalibrateCamera.apkUnalign -d -f build/dex/classes.dex -v -z build/CalibrateCamera.apkPart
